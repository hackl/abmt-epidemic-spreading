...
\begin{axis}[%
  ...
  xlabel={Time during the epidemic event [$hours$]},
  ylabel={Affected population [$\#$]},
  title={SI-Model Sioux Falls},
  grid=both,
  %xmode=log,
  %ymode=log,
  width=80mm,
...
\addplot[line width=1pt,col2] table [x=hour, y=susceptible, col sep=comma] {./data/si.csv};
\addplot[line width=1pt,col3] table [x=hour, y=infected, col sep=comma] {./data/si.csv};
